...
// 暂时去掉 namespace, 以便更好地在各种文件内出现....
// 代码上线前要把所有 TextDebug.SetText() 都注释掉 !!!
...
public class TextDebug : MonoBehaviour
{
    ...
    // ================ Static ================= //
    public static bool isActive = false; // 能将本 class 的所有功能变哑
    ...
    public static void SetActive( bool isActive_ )
    {
        isActive = isActive_;
    }
    ...
    static TextDebug FindOrCreate()
    {
        ...
        Canvas uiCanvas = DebugUtils.FindOrCreateUICanvas();
    ...
    static TextDebug FindOrCreateTextDebugCanvas( Transform parent_ )
    {
        ...
        */
        ...
        if( textDebugCanvasTF == null )
        {
            ...
            newGo.transform.SetParent( parent_, true );
